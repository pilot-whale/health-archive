...
import { checkupReportListService } from '@/api/checkupReport'
...
const checkupReportList = async () => {
    ...
    let result = await checkupReportListService(params);
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>体检记录管理</span>
                <!-- <div class="extra">
                    <el-button type="primary" @click="visibleDrawer = true">上传体检报告</el-button>
                </div> -->
            </div>
        </template>
        <!-- 搜索表单 -->
