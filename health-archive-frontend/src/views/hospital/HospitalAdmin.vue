...
<template>
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>体检机构查询</span>
                <el-button type="primary" @click="visibleDrawer = true">上传机构信息</el-button>
            </div>
        </template>
        <!-- 搜索表单 -->
        <el-form inline>
        ...
        <!-- 抽屉 -->
        <el-drawer v-model="visibleDrawer" title="添加体检机构" direction="rtl" size="50%">
            <el-form :model="articleModel" label-width="100px">
                <el-form-item label="医院名称">
                    <el-input v-model="articleModel.title" placeholder="请输入医院名称"></el-input>
                </el-form-item>
                <el-form-item label="邮编">
                    <el-input v-model="articleModel.title" placeholder="请输入邮编"></el-input>
                </el-form-item>
                <el-form-item label="联系电话">
                    <el-input v-model="articleModel.title" placeholder="请输入联系电话"></el-input>
                </el-form-item>
                <el-form-item label="官网">
                    <el-input v-model="articleModel.title" placeholder="请输入官网"></el-input>
                </el-form-item>

                <el-form-item label="地址">
                    <div class="editor">
                        <el-input type="textarea" v-model="articleModel.content" :rows="5" placeholder="请输入地址" />
                    </div>
                </el-form-item>

                <el-form-item label="医院性质：" style="width: 250px">
                    <el-select placeholder="请选择" v-model="state">
                        <el-option label="公立医院" value="公立医院"></el-option>
                        <el-option label="私立医院" value="私立医院"></el-option>
                    </el-select>
                ...
                <el-form-item>
                    <el-button type="primary" @click="addArticle('已发布')">上传</el-button>
